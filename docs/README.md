# Munmai Documentation

This directory contains maintained technical and operational documentation for
the merged codebase.
...
| [Deployment](../DEPLOYMENT.md) | Render, Vercel, MongoDB, protected files, and mobile configuration |
| [Mobile guide](../mobile/README.md) | Expo setup, routes, capture, authentication, and troubleshooting |
| [Changelog](../CHANGELOG.md) | Historical web release notes |

Historical screenshots remain under [`screenshots/`](screenshots/). They are
reference artifacts and may not represent every current state.
