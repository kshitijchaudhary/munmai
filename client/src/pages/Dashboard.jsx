      ...
      <main className="mx-auto max-w-7xl px-4 py-8 md:px-6 md:py-10 lg:ml-72">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-4 space-y-8">
            ...
            <div id="tax-pack" className="scroll-mt-28 rounded-3xl border border-slate-100 bg-white p-5 shadow-sm md:p-6 lg:scroll-mt-8">
          ...
          <div id="transactions" className="lg:col-span-8 scroll-mt-28 overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm lg:scroll-mt-8">
